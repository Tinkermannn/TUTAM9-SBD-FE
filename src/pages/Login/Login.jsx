...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await toast.promise(
                axios.post(`${import.meta.env.VITE_API}user/login`, { email, password }),
                {
                    pending: "Logging in...",
            ...
            if (response.data.success) {
                ...
                navigate(`/user/profile/${response.data.payload.user_id}`);
            } else {
    ...
    return (
        <>
            <div className="w-full min-h-screen m-auto flex bg-gradient-to-bl from-orange-700 via-sky-500 to-orange-400 max-md:px-4 max-md:py-8 max-md:items-center max-md:justify-center">
                <div className="w-full h-[500px] px-20 pt-[50px] flex items-center justify-start m-auto max-w-screen-2xl flex-row gap-0
                    ...
                    <div className="w-[50%] h-full rounded-l-xl border-orange-800 border-solid border-2 shadow-xl px-5 py-5 text-left bg-white flex-col justify-center
                        ...
                        <div className="w-full h-[15%] flex items-center flex-col max-md:h-auto max-md:mb-4">
                            <p className="w-full font-semibold text-black-800 text-2xl max-md:text-center">Sign In</p>
                            <p className="w-full font-normal text-black-800 text-sm max-md:text-center max-md:mt-2">
                        ...
                        <form className="w-full h-[60%] py-5 grid grid-rows-4 gap-20 max-md:h-auto max-md:grid-rows-none max-md:gap-4" onSubmit={handleLogin}>
                            ...
                            <div className="W-10 h-12 flex items-center justify-center mt-4 max-md:px-4">
                                <button
                                    className="w-full h-10 flex items-center bg-gradient-to-br from-orange-700 to-orange-500 shadow-md rounded-md justify-center"
                                    type="submit"
                                >
                            ...
                            <div className="flex h-6 py-2 my-2 w-full justify-center items-center gap-1 max-md:flex-col max-md:gap-2">
                                <a className="text-black-800 max-md:text-center">Don't have an account?</a>
                                <a href="/user/register" className="text-black-900 font-bold max-md:text-center">Sign Up Now!</a>
                            </div>
