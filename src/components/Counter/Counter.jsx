...
export default function Counter() {
    ...
    return (
        <div className="w-full h-[200px] flex bg-gradient-to-b from-fuchsia-900 via-purple-900 to-fuchsia-900">
            <div className='w-full h-full px-10 lg:px-20 flex items-center m-auto max-w-screen-2xl flex-row gap-10'>
                <div className='w-full h-full flex flex-col items-center gap-5'>
                    ...
                    <div className='flex flex-row h-full w-42 lg:w-[20%] items-center justify-center text-center gap-5'>
                        ...
                        <a className='flex-none h-10 lg:h-8 w-14 bg-white rounded-lg text-fuchsia-700 font-bold hover:bg-fuchsia-200 active:bg-fuchsia-600 active:text-white select-none  cursor-pointe flex items-center justify-center'
